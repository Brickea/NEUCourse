...
-- -----------------------------------------------------
-- Table `mydb`.`pathsOnFloor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`pathsOnFloor` (
  `idpathOnFloor` INT NOT NULL,
  `idnavigationRequest` INT NOT NULL,
  `temporaryDestination` INT NOT NULL,
  `timeCost` INT NOT NULL,
  `navigationOrder` INT NOT NULL COMMENT 'This order is to indicate the order to navigate user.',
  PRIMARY KEY (`idpathOnFloor`),
  INDEX `idnavigationforpaths_idx` (`idnavigationRequest` ASC),
  CONSTRAINT `idnavigationforpaths`
